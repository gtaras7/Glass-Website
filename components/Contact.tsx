         ...
         <GlassCard className="p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-12">
               ...
               <div>
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <span className="text-slate-700 dark:text-white/80">gftarasidis@gmail.com</span>
                     </div>
                  </div>
               </div>
               ...
               <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="pt-2">
                     <button className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20 dark:shadow-blue-900/50 transition-all transform hover:-translate-y-1">
                        Send Message <Send size={18} />
                     </button>
                  </div>

                  <div className="flex items-center justify-center gap-2 text-xs text-slate-400 dark:text-white/30 mt-4">
                     <div className="w-1.5 h-1.5 rounded-full bg-green-500"></div>
                     <span>Powered by n8n automation (Alerts my Telegram instantly)</span>
                  </div>
               </form>
            </div>
         </GlassCard>
