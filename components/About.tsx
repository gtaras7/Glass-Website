            ...
            <div className="max-w-3xl space-y-6 text-center">
               ...
               <GlassCard className="p-6 md:p-8 !bg-white/60 dark:!bg-white/5">
                  ...
                  <p className="text-slate-600 dark:text-white/60 mb-6">
                     {t('about.paragraph2').split('ServiceNow')[0]}
                     <strong className="text-cyan-600 dark:text-cyan-300">ServiceNow</strong>
                     {t('about.paragraph2').split('ServiceNow')[1].split('n8n')[0]}
                     <strong className="text-cyan-600 dark:text-cyan-300">n8n</strong>
                     {t('about.paragraph2').split('n8n')[1]}
                  </p>
